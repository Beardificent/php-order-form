        ...
        <fieldset>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <span class="error">*Required <?php echo $streetErr;?></span>

                </div>
                <div class="form-group col-md-6">
                    <label for="streetnumber">Street number:</label>
                    <input type="text" id="streetnumber" name="streetnumber" class="form-control" value="<?php echo $streetNum;?>">
                    <span class="error">*Required <?php echo $streetNumErr;?></span>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <span class="error">*Required <?php echo $cityErr;?></span>
                </div>
                <div class="form-group col-md-6">
                    <label for="zipcode">Zipcode</label>
                    <input type="text" id="zipcode" name="zipcode" class="form-control" value="<?php echo $zipcode;?>">
                    <span class="error">*Required <?php echo $zipcodeErr;?></span>
                </div>
            </div>
        </fieldset>
